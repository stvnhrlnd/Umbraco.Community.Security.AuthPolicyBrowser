...
namespace Umbraco.Community.Security.AuthPolicyBrowser.Composers
{
    public class UmbracoCommunitySecurityAuthPolicyBrowserApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Community Security Auth Policy Browser Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoCommunitySecurityAuthPolicyBrowserOperationSecurityFilter>();
            });
        }

        public class UmbracoCommunitySecurityAuthPolicyBrowserOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.Security.AuthPolicyBrowser.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
